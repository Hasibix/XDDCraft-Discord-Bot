            ...
            mutee.roles.set([muterole.id]).then(() => {
                mutee.send(`**You have been muted in ${message.guild.name} for - ${reason || "No Reason"}`).catch(() => null)
                 ...
                 mutee.roles.set([muterole.id])                               
                   ...
                   if (reason) {
                message.channel.send(`[${client.emoji.success}] ${mutee.user.username} was successfully muted! Reason: ${reason}`);
                } else {
                message.channel.send(`[${client.emoji.success}] ${mutee.user.username} was successfully muted!`);
                }
